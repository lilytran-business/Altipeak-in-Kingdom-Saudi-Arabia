      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        >
          <img 
            ...
            alt="Altipeak High Performance Facility"
          />
        </div>
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10 grid lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-500">
            <a href="#vision" className="w-full sm:w-auto text-center gold-gradient text-slate-950 px-12 py-6 rounded-full font-black uppercase tracking-widest hover:scale-105 hover:shadow-[0_0_40px_rgba(212,175,55,0.4)] transition-all group">
              View Pilot Use-Cases
            </a>
            <a href="#engagement" className="w-full sm:w-auto text-center border-2 border-white/10 bg-white/5 backdrop-blur-md hover:border-[#3881FC] hover:bg-[#3881FC]/10 px-12 py-6 rounded-full font-black uppercase tracking-widest text-white transition-all">
        ...
        <div className="lg:col-span-5 relative flex flex-col items-center lg:items-end gap-6">
          ...
          <div className="relative mb-12 animate-in zoom-in duration-1000 delay-300">
            ...
            <img 
              ...
              alt="Vision 2030" 
              className="h-32 md:h-44 object-contain relative z-10 animate-slow-rotate"
            />
          </div>
