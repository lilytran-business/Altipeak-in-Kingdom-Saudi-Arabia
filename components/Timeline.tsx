...
const Timeline: React.FC<{ id: string }> = ({ id }) => {
  ...
  return (
    <section id={id} ref={sectionRef} className="section-reveal relative py-40 px-6 md:px-12 overflow-hidden bg-[#0A192F]">
          ...
          {roadmap.map((step, idx) => (
            ...
            >
              <div className="flex-1 w-full">
                <div className="relative p-10 md:p-14 glass-card rounded-[4rem] border border-white/5 hover:border-[#D4AF37]/40 transition-all duration-700 hover:-translate-y-4 hover:shadow-[0_40px_80px_rgba(0,0,0,0.6)] group/card shadow-2xl">
