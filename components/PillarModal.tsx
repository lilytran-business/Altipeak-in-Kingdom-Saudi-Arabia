...
const PillarModal: React.FC<PillarModalProps> = ({ pillar, onClose }) => {
  ...
  const galleryItems = [
    {
      url: "https://res.cloudinary.com/dpweu2ene/image/upload/v1768809658/Copy_of_665_b5sx2i.jpg",
      title: "European-engineered systems",
      text: "Manufactured to Altipeak™ specifications through approved global partners",
      ref: "Ref ID #102"
    },
    {
      url: "https://res.cloudinary.com/dpweu2ene/image/upload/v1768809601/2_zjuvjz.png",
      title: "Clinical Operating Environment",
      text: "Clinically supervised protocols with real-time monitoring",
      ref: "Ref ID #103"
    },
    {
      url: "https://res.cloudinary.com/dpweu2ene/image/upload/v1768809578/699_zeor1w.jpg",
      title: "Elite Performance Systems",
      text: "Data-driven conditioning in controlled training environments",
      ref: "Ref ID #104"
    },
    {
      url: "https://res.cloudinary.com/dpweu2ene/image/upload/v1768809496/Screenshot_2026-01-06_050056_nne4zc.png",
      title: "Local KSA capability",
      text: "Via authorized distributor (Sascom / Al-Rashed Group)",
      ref: "Ref ID #105"
    }
  ];
      ...
      <div className="relative w-full h-full max-w-7xl glass-card md:rounded-[4rem] overflow-hidden flex flex-col shadow-[0_0_120px_rgba(0,0,0,1)] border-white/10 animate-in zoom-in-95 slide-in-from-bottom-10 duration-700">
          ...
          <div className="p-8 md:p-20">
            ...
            <div className="mt-40">
              ...
              <div className="grid lg:grid-cols-12 gap-10">
                {/* Case Study Video Area - Replaced YouTube with direct Cloudinary MP4 */}
                <div 
                  className="lg:col-span-7 aspect-video rounded-[3rem] bg-slate-900 overflow-hidden relative group cursor-pointer border border-white/5"
                  onClick={() => setIsVideoPlaying(true)}
                >
                  {!isVideoPlaying ? (
                    <>
                      <img 
                        src="https://res.cloudinary.com/dpweu2ene/image/upload/v1768809658/Copy_of_665_b5sx2i.jpg" 
                        alt="Video Thumbnail"
                        className="w-full h-full object-cover opacity-60 group-hover:scale-105 transition-transform duration-1000"
                      />
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-24 h-24 rounded-full bg-[#D4AF37] flex items-center justify-center text-slate-950 shadow-2xl group-hover:scale-110 transition-transform duration-300">
                ...
                {/* Installation Gallery with Unique Content */}
                  ...
                  {galleryItems.map((item, i) => (
                    <div key={i} className="flex items-center gap-6 p-4 rounded-[2rem] bg-white/5 border border-white/5 hover:border-[#3881FC]/30 transition-all group overflow-hidden">
                       ...
                       <div className="flex-1">
                        <p className="text-[9px] font-black text-[#D4AF37] uppercase tracking-widest mb-1">{item.ref}</p>
                        <h6 className="text-sm font-black text-white uppercase leading-tight mb-1">{item.title}</h6>
                        <p className="text-[10px] text-slate-500 font-bold uppercase tracking-tight line-clamp-2">{item.text}</p>
                       </div>
                    </div>
                  ))}
                </div>
        ...
        <div className="p-8 md:px-20 md:py-10 bg-[#112240] border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-8 z-50">
          ...
          <div className="flex gap-4 w-full md:w-auto">
            ...
            >
              <FileText size={18} /> Download Strategic Brief
            </a>
            <button 
              onClick={onClose}
