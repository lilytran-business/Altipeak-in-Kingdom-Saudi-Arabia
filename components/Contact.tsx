...
import { Send, User, Building, Mail, Phone, MessageSquare, Linkedin, MessageCircle, CheckCircle2, Target } from 'lucide-react';
      ...
      <div className="container mx-auto max-w-6xl">
        {!isSubmitted ? (
          <div className="glass-card rounded-[3rem] overflow-hidden grid lg:grid-cols-2 shadow-2xl animate-in fade-in duration-700">
            {/* Left Column - Branding & Info (UNTOUCHED) */}
            <div className="p-10 md:p-16 gold-gradient flex flex-col justify-between text-slate-950 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <img src="https://res.cloudinary.com/dpweu2ene/image/upload/v1768813034/Vision-2030-logo_1_134740_cmwlbz.png" 
                     alt="Vision 2030" className="h-16 mb-12 opacity-90 object-contain" />
            ...
            <div id="contact-form" className="p-10 md:p-16 bg-slate-900">
              <div className="mb-10">
                <h3 className="text-2xl font-black mb-2 text-white uppercase tracking-tight">Request Government Pilot Discussion</h3>
                <p className="text-[#3881FC] text-[10px] font-black uppercase tracking-[0.15em] leading-relaxed">
                  For ministries, federations, and Vision 2030 delivery partners.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="relative group">
                    <select className="peer w-full bg-slate-800/50 border-b-2 border-slate-700 py-3 outline-none text-white focus:border-[#D4AF37] transition-all appearance-none cursor-pointer text-xs font-bold uppercase">
                    ...
                    <label className="absolute -top-5 left-1 text-[#3881FC] font-black uppercase tracking-widest text-[10px]">
                  ...
                  <div className="relative group">
                    <select className="peer w-full bg-slate-800/50 border-b-2 border-slate-700 py-3 outline-none text-white focus:border-[#D4AF37] transition-all appearance-none cursor-pointer text-xs font-bold uppercase">
                      <option className="bg-slate-900">Proof of Concept Pilot</option>
                      <option className="bg-slate-900">Technology Validation Hub</option>
                      <option className="bg-slate-900">Workforce Training & Academy</option>
                      <option className="bg-slate-900">Industrial Scalability Review</option>
                      <option className="bg-slate-900">Direct Infrastructure Deployment</option>
                    </select>
                    <label className="absolute -top-5 left-1 text-[#D4AF37] font-black uppercase tracking-widest text-[10px]">
                      <span className="flex items-center gap-2"><Target size={12}/> Objective</span>
                    </label>
                  </div>
                </div>
                ...
                <button 
                  type="submit" 
                  className="relative w-full gold-gradient text-slate-950 font-black uppercase tracking-[0.2em] py-5 rounded-xl shadow-lg hover:shadow-[#D4AF37]/30 transition-all duration-300 overflow-hidden group hover:scale-[1.02] active:scale-95 mt-4"
                >
                  ...
                  <span className="flex items-center justify-center gap-3 relative z-10">
                    ...
                    Request Government Pilot Discussion
                  </span>
                </button>
              </form>
              
              <p className="text-[10px] text-slate-500 text-center mt-10 uppercase tracking-widest font-bold">
                Secure Institutional Portal • Private Consultation • NDA Protected
              </p>
            </div>
          </div>
        ) : (
          <div className="glass-card rounded-[3rem] p-16 md:p-24 bg-slate-900/50 backdrop-blur-3xl border-2 border-[#D4AF37] shadow-[0_0_80px_rgba(212,175,55,0.2)] text-center animate-in zoom-in-95 duration-700 relative overflow-hidden">
            ...
            <p className="text-slate-300 text-lg leading-relaxed max-w-lg mx-auto mb-12 font-medium">
              Your inquiry has been prioritized for the <span className="text-[#D4AF37] font-black">CEO's Office</span>. A strategic liaison will contact you within 12 standard operating hours regarding the pilot discussion.
            </p>
            <button 
